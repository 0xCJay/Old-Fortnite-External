...
inline ImColor AccentCol = ImVec4(accentcolor[0], accentcolor[1], accentcolor[2], accentcolor[4]);

inline float OtherColor[4] = { 1.f, 1.f, 1.f, 1.0f };

inline ImColor OtherCol = ImVec4(OtherColor[0], OtherColor[1], OtherColor[2], OtherColor[4]);